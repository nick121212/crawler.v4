...
let Website = class Website extends base_1.CrawlerBaseEntity {
...
__decorate([
    typeorm_1.ManyToOne(type => flow_1.Flow, flow => flow.websites, {
        cascadeInsert: true,
        cascadeRemove: true,
        cascadeUpdate: true
    }),
    __metadata("design:type", flow_1.Flow)
], Website.prototype, "flow", void 0);
Website = __decorate([
    typeorm_1.Entity(),
